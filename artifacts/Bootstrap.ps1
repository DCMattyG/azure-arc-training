...
$chocolateyAppList = 'azure-cli,az.powershell,vcredist140,microsoft-edge,azcopy10,vscode,git,7zip,putty.install,dotnetcore-3.1-sdk,setdefaultbrowser'
...
Invoke-WebRequest ($templateBaseUrl + "img/arcbox_wallpaper.png") -OutFile $Env:ArcBoxDir\wallpaper.png
...
Write-Host "Fetching Workbook Template Artifact"
...
Invoke-WebRequest ($templateBaseUrl + "artifacts/blockIMDS.sh") -OutFile $Env:ArcBoxDir\agentScript\blockIMDS.sh
